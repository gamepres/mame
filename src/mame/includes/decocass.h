...
public:
	...
	DECLARE_MACHINE_RESET(cterra2a);
	DECLARE_MACHINE_RESET(cnebul2a);
	DECLARE_MACHINE_RESET(castro6a);
	DECLARE_MACHINE_RESET(ctower0a);
	DECLARE_MACHINE_RESET(csastf4a);
